...
{
    const unsigned char * p3 = &(im.data())[(pos.y - 3) * im.widthStep()];
    const unsigned char * p2 = &(im.data())[(pos.y - 2) * im.widthStep()];
    const unsigned char * p1 = &(im.data())[(pos.y - 1) * im.widthStep()];
    const unsigned char * s  = &(im.data())[pos.y * im.widthStep()];
    const unsigned char * n1 = &(im.data())[(pos.y + 1) * im.widthStep()];
    const unsigned char * n2 = &(im.data())[(pos.y + 2) * im.widthStep()];
    const unsigned char * n3 = &(im.data())[(pos.y + 3) * im.widthStep()];
    float Dxx = 0.0f;
    float Dxy = 0.0f;
    float Dyy = 0.0f;
